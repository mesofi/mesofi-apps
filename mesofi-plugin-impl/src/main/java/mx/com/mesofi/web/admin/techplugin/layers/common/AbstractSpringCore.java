...
/**
 * This class defaults some values for the SpringCore layer.
 * 
 * @author Armando Rivas
 * @since April 12 2015.
 */
public abstract class AbstractSpringCore extends AbstractCommonBuilder implements SpringCore {
    /**
     ...
     */
    public AbstractSpringCore(ApplicationBuilderVo builder) {
        super(builder);
    }

    /**
     * This method return the default suffix name for the sources, in this case
     * is 'Vo'. This suffix can be optional.
     * 
