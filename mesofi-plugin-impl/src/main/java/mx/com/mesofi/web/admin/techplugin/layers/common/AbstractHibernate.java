...
/**
 * This class defaults some values for the Hibernate layer.
 * 
 * @author Armando Rivas
 * @since April 14 2015.
 */
public abstract class AbstractHibernate extends AbstractCommonBuilder implements Hibernate {
    /**
     ...
     */
    public AbstractHibernate(ApplicationBuilderVo builder) {
        super(builder);
    }
