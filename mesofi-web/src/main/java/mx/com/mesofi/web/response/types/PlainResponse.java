...
/**
 * Class to handle the Plain responses.
 * 
 * @author Armando Rivas.
 * @since Oct 11 2013
 */
public class PlainResponse extends AbstractResponse implements WebResponse {
    /**
     ...
     */
    public PlainResponse(Object object) {
        setObjectToConvert(object, PlainResponse.class);
    }
