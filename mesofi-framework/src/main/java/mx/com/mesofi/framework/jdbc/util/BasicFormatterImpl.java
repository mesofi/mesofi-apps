...
import static mx.com.mesofi.services.util.CommonConstants.SPECIAL_WHITE_SPACE;
...
/**
 * Best implementation known so far. This class formats any SQL statement and
 * returns as a result the corresponding SQL statement in a more readable way.
 * 
...
public class BasicFormatterImpl implements Formatter {
    ...
    private static class FormatProcess {
        ...
        public FormatProcess(String sql) {
            tokens = new StringTokenizer(sql, "()+*/-=<>'`\"[]," + SPECIAL_WHITE_SPACE.toString(), true);
        }
        ...
        private static boolean isWhitespace(String token) {
            return SPECIAL_WHITE_SPACE.toString().indexOf(token) >= 0;
        }
